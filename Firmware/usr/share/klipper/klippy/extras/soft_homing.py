import logging, math
SOFT_HOMING_X_ERR_CODE  = {'code':'key404', 'msg':'Homing failed due to printer shutdown,Y sotf homing err', 'values':[]}
SOFT_HOMING_Y_ERR_CODE  = {'code':'key403', 'msg':'Homing failed due to printer shutdown,X sotf homing err', 'values':[]}
class SoftHomingInit:
    ...
    def __init__(self, config):
        ...
        self.home_cnt_max = config.getint('home_cnt_max', default=15, minval=10, maxval=30)
